...
@app.route("/health", methods=["GET"]) # Dedicated health check route for monitoring
def health_check(): # Function used by Kubernetes/Docker probes
    return {"status": "healthy"}, 200 # Return 200 OK without affecting visit counter
